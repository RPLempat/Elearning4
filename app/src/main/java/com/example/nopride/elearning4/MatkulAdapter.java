...
public class MatkulAdapter extends RecyclerView.Adapter<MatkulAdapter.MyViewHolder>{
    ...
    public MatkulAdapter(List<Mahasiswa> MahasiswaList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_matkul, parent, false);
...
//        holder.mTextViewNim.setText("NIM = " + mMahasiswaList.get(position).getNama());
        holder.mTextViewNama.setText("NAMA = " + mMahasiswaList.get(position).getProdi());
//        holder.mTextViewPass.setText("PASS = " + mMahasiswaList.get(position).getFakultas());
...
//        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
//            mTextViewNim = (TextView) itemView.findViewById(R.id.nama);
